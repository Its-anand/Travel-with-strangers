...
{
    $user_exist_query="SELECT * FROM `travel_with_strangers_registration_user` where `username`= '$_POST[username]' OR `email` ='$_POST[email]'";
    ...
    if($result)
    {
        ...
        else
        {
         ...
         $query="INSERT INTO `registered_users`(`full_name`, `username`, `email`, `password`, `location`, `verification_code`, `is_verified`) VALUES ('$_POST[full_name]','$_POST[username]','$_POST[email]','$_POST[location],'$v_code')";
