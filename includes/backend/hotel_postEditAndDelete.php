...
if(!isset($_SESSION['logged_in'])){
    ...
    if(isset($_POST['editBTN'])){
        ...
        if($result){
        alert("Post updated Successfully",'S','../../includes/frontend/Hotel/profile.php');
        }
        else{
        ...
        $result=mysqli_query($con,$deletePost);
            if($result){
            alert("Post Deleted Successfully",'S','../../includes/frontend/Hotel/profile.php');
            }
            else{
                alert("Unable to connect to database",'D','../../includes/frontend/Hotel/profile.php');
            }
        ...
        alert("No button pressed",'W','../../includes/frontend/Hotel/profile.php');
    }
?>
