  ...
  * {
  ...
  <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <!--[if mso]><table width="100%"><tr><td><![endif]-->
      <h1 style="margin: 0px; color: #ffffff; line-height: 100%; text-align: center; word-wrap: break-word; font-family: "Montserrat",sans-serif; font-size: 31px; font-weight: 700;"><span><span><span><span><span><span><span><span style="line-height: 29px;"><span style="line-height: 29px;"><span style="line-height: 29px;">Join Travel with strangers<br /></span></span></span></span></span></span></span></span></span></span></h1>
  ...
  <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <!--[if mso]><table width="100%"><tr><td><![endif]-->
      <h1 style="margin: 0px; color: #e03e2d; line-height: 100%; text-align: center; word-wrap: break-word; font-family: "Montserrat",sans-serif; font-size: 30px; font-weight: 700;"><span>Find here memories with<br />Travel with strangers</span></h1>
    <!--[if mso]></td></tr></table><![endif]-->
  ...
  <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div style="font-size: 14px; color: #e03e2d; line-height: 140%; text-align: center; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 140%;"><span style="color: #e03e2d; line-height: 19.6px;"><a rel="noopener" href="#" target="_blank" style="color: #e03e2d; text-decoration:none;">CONTACT ME</a></span>  |  <span style="color: #e03e2d; line-height: 19.6px;"><a rel="noopener" href="#" target="_blank" style="color: #e03e2d; text-decoration:none;">ABOUT Me</a></span>  |   <span style="color: #e03e2d; line-height: 19.6px;"><a rel="noopener" href="#" target="_blank" style="color: #e03e2d;"><span style="line-height: 19.6px; text-decoration:none;">HOME</span></a></span></p>
    </div>
...
if(isset($_POST['user-registration']))
{
    ...
    if($result)
    {
        ...
        else
        {
            ...
            // // Check file size
            // if ($_FILES["user_profile_image"]["size"] > 500000) {
            ...
            // if everything is ok, try to upload file
              ...
              if (move_uploaded_file($_FILES["user_profile_image"]["tmp_name"], $target_file)) {
                // alert( "The file ". htmlspecialchars( basename( $_FILES["user_profile_image"]["name"])). " has been uploaded.",'D','../../Index.php');
              } else {
